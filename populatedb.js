...
async function itemCreate(name, description, category, price, quantityInStock) {
  const itemDetail = { name, category, price, quantityInStock };
...
async function createItems() {
  ...
  await Promise.all([
    itemCreate("French Loaf 2 Count", "8 oz Loaves", categories[0], 2.99, 50),
    itemCreate(
    ...
    itemCreate("Honeycrisp Apples", "", categories[3], 1.34, 500),
    itemCreate(
      "Red Bell Pepper",
      "Sweet, Mild Taste",
      categories[3],
